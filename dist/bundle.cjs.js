...
var SkelWrapper = function SkelWrapper(_a) {
  var _b, _c;
  var children = _a.children,
    loading = _a.loading,
    width = _a.width,
    height = _a.height,
    _d = _a.color,
    color = _d === void 0 ? "#eaeaea" : _d,
    _e = _a.borderRadius,
    borderRadius = _e === void 0 ? 5 : _e,
    _f = _a.fadeIn,
    fadeIn = _f === void 0 ? false : _f,
    _g = _a.uprise,
    uprise = _g === void 0 ? false : _g,
    props = __rest$1(_a, ["children", "loading", "width", "height", "color", "borderRadius", "fadeIn", "uprise"]);
  return /*#__PURE__*/React.createElement(picsso.div, {
    pb: (_b = props.pb) !== null && _b !== void 0 ? _b : 8,
    pr: (_c = props.pr) !== null && _c !== void 0 ? _c : 8
  }, /*#__PURE__*/React.createElement(picsso.div, {
    css: css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n        ", "\n        ", "\n      ", "\n      ", "\n      "], ["\n        ", "\n        ", "\n      ", "\n      ", "\n      "])), skelWrapperAnimation, afterSkelWrapperFadeIn, afterSkelWrapperUprise, loading ? loadingStyle({
      color: color
    }) : afterLoadingEffect({
      fadeIn: fadeIn,
      uprise: uprise
  ...
  }, /*#__PURE__*/React.createElement(picsso.div /** raw text인 children에 opacity 적용하기 위한 div */, null, children)));
};
var skelWrapperAnimation = css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  @keyframes skel-wrapper-animation {\n    0% {\n      opacity: 0.5;\n    }\n    50% {\n      opacity: 1;\n    }\n    100% {\n      opacity: 0.5;\n    }\n  }\n"], ["\n  @keyframes skel-wrapper-animation {\n    0% {\n      opacity: 0.5;\n    }\n    50% {\n      opacity: 1;\n    }\n    100% {\n      opacity: 0.5;\n    }\n  }\n"])));
var afterSkelWrapperFadeIn = css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  @keyframes after-skel-wrapper-fade-in {\n    from {\n      opacity: 0;\n    }\n    to {\n      opacity: 1;\n    }\n  }\n"], ["\n  @keyframes after-skel-wrapper-fade-in {\n    from {\n      opacity: 0;\n    }\n    to {\n      opacity: 1;\n    }\n  }\n"])));
var afterSkelWrapperUprise = css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  @keyframes after-skel-wrapper-uprise {\n    from {\n      opacity: 0;\n      transform: translateY(20px);\n    }\n    to {\n      opacity: 1;\n      transform: translateY(0);\n    }\n  }\n"], ["\n  @keyframes after-skel-wrapper-uprise {\n    from {\n      opacity: 0;\n      transform: translateY(20px);\n    }\n    to {\n      opacity: 1;\n      transform: translateY(0);\n    }\n  }\n"])));
var loadingStyle = function loadingStyle(_a) {
  var color = _a.color;
  return css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  div {\n    opacity: 0;\n  }\n  animation: skel-wrapper-animation infinite 1s;\n  background: ", ";\n"], ["\n  div {\n    opacity: 0;\n  }\n  animation: skel-wrapper-animation infinite 1s;\n  background: ", ";\n"])), color);
};
var afterLoadingEffect = function afterLoadingEffect(_a) {
  var fadeIn = _a.fadeIn,
    uprise = _a.uprise;
  return css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  div {\n    ", "\n    ", "\n  }\n"], ["\n  div {\n    ", "\n    ", "\n  }\n"])), fadeIn ? css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n          animation: after-skel-wrapper-fade-in forwards 0.5s;\n        "], ["\n          animation: after-skel-wrapper-fade-in forwards 0.5s;\n        "]))) : "", uprise ? css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n          animation: after-skel-wrapper-uprise forwards 0.4s;\n        "], ["\n          animation: after-skel-wrapper-uprise forwards 0.4s;\n        "]))) : "");
};
var templateObject_1, templateObject_2, templateObject_3, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8;

var Repeat = function Repeat(_a) {
  var children = _a.children,
    loading = _a.loading,
    amount = _a.amount,
    _b = _a.repeatDirection,
    repeatDirection = _b === void 0 ? "column" : _b;
  return loading ? new Array(amount).fill(undefined).map(function (_, i) {
    return /*#__PURE__*/React.createElement(picsso.div, {
      key: i,
      flex: true,
      flexDirection: repeatDirection
    }, children);
  }) : ( /*#__PURE__*/React.createElement(picsso.div, null, children));
};

exports.Repeat = Repeat;
exports.default = SkelWrapper;
